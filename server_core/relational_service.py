...
class RelationalDatabaseService:
    ...
    def _new_engine(self, cfg: dict[str, Any]):
        ...
        if cfg["engine"] == "sqlite": options["connect_args"] = {"check_same_thread": False, "timeout": 20}
    ...
    def finance_summary(self, month: str) -> dict[str, Any]:
        ...
        revenue = float(revenue or 0); profit = float(profit or 0); expenses = float(expenses or 0)
        ...
        return {
            ...
            "average_ticket": (revenue / order_count) if order_count else 0,
            "order_count": order_count, "pending": pending,
        }
